---
name: issue
description: "Use when the user asks to create an issue, report a bug, or track a feature request. Triggers: 'issue', '이슈 만들어', '이슈 생성', 'create issue', '버그 리포트', 'bug report', '기능 요청', 'feature request', '이슈 등록'"
---
...
- Issue URL
- Issue number
- Suggest: "Want to create a branch for this? Use `$branch`."
