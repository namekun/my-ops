---
name: commit-msg
description: "Use when the user asks to recommend commit messages or analyze changes for a commit message. Triggers: 'commit-msg', '커밋 메시지 추천', 'recommend commit message'"
---
