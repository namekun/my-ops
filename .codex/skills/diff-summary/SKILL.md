---
name: diff-summary
description: "Use when the user asks to summarize changes, show what changed, or analyze the current diff. Triggers: 'diff summary', 'diff 요약', '변경사항 요약', 'what changed', '뭐가 바뀌었어', 'summarize changes', '변경 내용 분석', 'diff 분석'"
---
...
- "Want a detailed review? Use `$review`."
- "Want to run checks first? Use `$pre-commit`."
