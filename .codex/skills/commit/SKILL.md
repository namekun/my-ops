---
name: commit
description: "Use when the user asks to commit changes, stage and commit, or make a git commit. Triggers: 'commit', '커밋해줘', '커밋', 'stage and commit'"
---
...
Do NOT push. If push is needed, suggest using the push skill.
